...
public class CompanyMainNew {
	
    @Test
    public void testThePricePerSquareFeet() {

        List<CompanyMainNew> theSalesData = new ArrayList<>();

        theSalesData.add(new CompanyMainNew("TVM", 1600, 800));
        theSalesData.add(new CompanyMainNew("Chennai", 1800, 1000));
        theSalesData.add(new CompanyMainNew("Hyderabad", 2000, 900));
        theSalesData.add(new CompanyMainNew("Mumbai", 2500, 1200));
        theSalesData.add(new CompanyMainNew("Cochin", 1800, 1200));
